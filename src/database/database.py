...
class Timetable:
    ...
    def get_classes(self, day: str, week_type: str) -> list[str, dict[str, str | int]]:
        day = day.capitalize()
    ...
    def add_class(self, day: str, time: str, class_name: str, room_number: int, week_type: str) -> None:
        day = day.capitalize()
    ...
    def remove_class(self, day: str, time: str, week_type: str) -> None:
        day = day.capitalize()  # Consistent with JSON format
